...
def main():
    ...
    # Set inputs
    chemise.input['tour_taille'] = 70
    chemise.input['tour_poitrine'] = 90
    chemise.input['taille_dos'] = 70
    chemise.input['longueur_manche'] = 83

    pantalon.input['hanche'] = 95
    pantalon.input['longueur_jambe'] = 80
    ...
    print(f"Taille chemise est : {chemise_taille}")
    print(f"Taille pantalon: {pantalon_taille}")
